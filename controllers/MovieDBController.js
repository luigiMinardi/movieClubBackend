...
MovieDBController.getSearchMovies = async (req, res) => {
    ...
    try {
        let result = await axios.get(
            `${root}search/movie?api_key=${key}&language=${language}&query=${search}&page=${page}&include_adult=false`
        );
...
MovieDBController.getNewMovies = async (req, res) => {
    try {
        let result = await axios.get(
            `${root}movie/upcoming?api_key=${key}&language=${language}&page=${page}`
        );
...
MovieDBController.getMovieById = async (req, res) => {
    ...
    try {
        let result = await axios.get(
            `${root}movie/${id}?api_key=${key}&language=${language}`
        );
        res.send(result.data);
    } catch (error) {
        res.send(error);
...
MovieDBController.getReviewByMovieId = async (req, res) => {
    ...
    try {
        let result = await axios.get(
            `${root}movie/${id}/reviews?api_key=${key}&language=${language}&page=${page}`
        );
        res.send(result.data);
    } catch (error) {
        res.send(error);
...
MovieDBController.getLatestMovie = async (req, res) => {
    try {
        let result = await axios.get(
            `${root}movie/latest?api_key=${key}&language=${language}`
        );
        res.send(result.data);
    } catch (error) {
        res.send(error);
...
MovieDBController.getTopRatedMovies = async (req, res) => {
    try {
        let result = await axios.get(
            `${root}movie/top_rated?api_key=${key}&language=${language}&page=${page}`
        );
        res.send(result.data);
    } catch (error) {
        res.send(error);
...
MovieDBController.getSimilarMovies = async (req, res) => {
    ...
    try {
        let result = await axios.get(
            `${root}movie/${id}/similar?api_key=${key}&language=${language}&page=${page}`
        );
        res.send(result.data);
    } catch (error) {
        res.send(error);
